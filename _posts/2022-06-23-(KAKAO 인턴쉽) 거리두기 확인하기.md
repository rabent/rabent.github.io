...
아래와 같은 규칙으로 대기실에 거리를 두고 앉도록 안내하고 있습니다.
 ...
 2.거리두기를 위하여 응시자들 끼리는 맨해튼 거리<sup id="a1">[1](#footnote1)</sup>가 2 이하로 앉지 말아 주세요.
...
><b id="footnote1">1</b>두 테이블 T1, T2가 행렬 (r1, c1), (r2, c2)에 각각 위치하고 있다면, T1, T2 사이의 맨해튼 거리는 |r1 - r2| + |c1 - c2| 입니다.  [↩](#a1)
